...
public class set implements Runnable {
    ...
    private static AtomicInteger globalCardId = new AtomicInteger(1);
    ...
    public void run() {
        ...
        if (cards.isEmpty()) {
            ...
            try {
                Thread.sleep(5000);  // Simple sleep for waiting, this can be replaced with more advanced methods later
    ...
    private synchronized int getNextCardId() {
        return globalCardId.getAndIncrement();
    }
